...
def get_reactome_pathway_names():
    ...
    react_name_path = "/v/projects/methyldeeplearn-pallag/paurel/pnet_aging/_database/pathways/Reactome/"
    print(react_name_path)
    reactome_pathways_df = pd.read_csv(
        join(react_name_path, 'ReactomePathways.txt'), sep='	',
        header=None)
